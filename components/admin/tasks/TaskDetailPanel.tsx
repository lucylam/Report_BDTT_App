...
export const TaskDetailPanel = ({ row }: TaskDetailPanelProps): React.ReactElement => {
  if (!row) {
    return (
      <aside className="rounded-[2rem] border border-[var(--border-strong)] bg-white/90 p-5 shadow-[var(--shadow-soft-sm)]">
  ...
  return (
    <aside className="sticky top-24 max-h-[calc(100dvh-7rem)] overflow-auto rounded-[2rem] border border-[var(--border-strong)] bg-white/95 p-5 shadow-[var(--shadow-soft-md)]">
      ...
      <div className="mt-4 rounded-2xl border border-[var(--border-strong)] bg-white p-4">
