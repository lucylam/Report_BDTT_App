...
export const TaskDetailPanel = ({ row }: TaskDetailPanelProps): React.ReactElement => {
  ...
  return (
    <aside className="soft-panel sticky top-24 max-h-[calc(100dvh-7rem)] overflow-auto p-5">
      ...
      <div className="mt-4 rounded-[1.5rem] bg-[var(--primary-pale)] p-4">
      ...
      <div className="mt-4 rounded-[1.5rem] border border-[var(--border-strong)] bg-white/82 p-4">
...
const Info = ({
  ...
  return (
    <div className="rounded-[1.25rem] bg-white/82 p-3 ring-1 ring-[var(--border-strong)]">
